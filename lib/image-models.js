...
const defaultModelConfig = {
    ...
    getRequestParams: (formValues) => ({
        ...
        num_inference_steps: parseInt(formValues.numInferenceSteps),
        guidance_scale: parseFloat(formValues.guidanceScale),
        safety_tolerance: formValues.safetyTolerance,
        output_format: formValues.outputFormat,
        num_images: parseInt(formValues.numImages),
        seed: formValues.seed ? parseInt(formValues.seed) : undefined
    }),
...
const dalleModelConfig = {
    ...
    getRequestParams: (formValues) => ({
        ...
        n: parseInt(formValues.numImages),
        response_format: formValues.outputFormat === 'png' ? 'b64_json' : 'url'
    }),
    validateParams: (params) => {
